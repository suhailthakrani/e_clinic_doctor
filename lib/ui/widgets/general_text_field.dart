...
class GeneralTextField extends StatelessWidget {
  ...
  GeneralTextField.withBorder({Key? key,required this.tfManager, this.suffixIcon, this.maxLines=1, this.paddingHorizontal=20, this.paddingVertical = 10, this.readOnly=false}) : super(key: key);

  GeneralTextField.withShadow({Key? key,required this.tfManager, this.suffixIcon, this.maxLines=1, this.paddingHorizontal=4, this.paddingVertical = 10, this.readOnly=false}) : super(key: key) {
        ...
        children: [
          ...
          Obx(()=> Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(_withShadow.isTrue ? 4 : 1),
                  border: _withShadow.isTrue ? null : Border.all(color: tfManager.errorMessage.isEmpty ? kFieldBorderColor : kRequiredRedColor),
                  color: readOnly ? kFieldGreyColor : _withShadow.isTrue ? kWhiteColor : kFieldGreyColor,
          ...
          Obx(() => Visibility(
            ...
            child: Text(tfManager.errorMessage.value, style: const TextStyle(color: kRequiredRedColor),),
          )),
        ],
      ),
    );
